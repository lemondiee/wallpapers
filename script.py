#first make a folder in your Newly created Repository. My folder name is WALLPAPER
Folder = "WALLPAPER"
...
#all images will be renamed. note the last image name would be the number of files in the folder. In my case, 582.
TotalIMG = 582 #1 more bcs range is just upto this and not including this
...
with open("index.html","w") as f:
    for i in range(1,TotalIMG):
        f.write(f'<img src="WALLPAPER/wallpaper ({i}).jpg" alt="wallpaper ({i})" width="90%"/> <br>')
